...
<?php
    $newQuery = 'SELECT COUNT(*) AS NewCount FROM appointments WHERE status="new" AND doctorId = ' . $_SESSION['user_id'];
...
<?php
    $approvedQuery = 'SELECT COUNT(*) AS ApprovedCount FROM appointments WHERE status="approved" AND doctorId = ' . $_SESSION['user_id'];
...
<?php
    $cancelledQuery = 'SELECT COUNT(*) AS CancelledCount FROM appointments WHERE status="cancelled" AND doctorId = ' . $_SESSION['user_id'];
...
<?php
    $allQuery = 'SELECT COUNT(*) AS AllCount FROM appointments WHERE doctorId = ' . $_SESSION['user_id'];
...
<?php
    $queryThisWeek = "SELECT DATE(appointments.dateOfAppointment) AS AppointmentDate, COUNT(*) AS PatientCount FROM appointments WHERE appointments.dateOfAppointment >= CURDATE() - INTERVAL 6 DAY AND doctorId = " . $_SESSION['user_id'] . " GROUP BY DATE(appointments.dateOfAppointment) ORDER BY AppointmentDate DESC";
...
<?php
    $sql = "SELECT CONCAT(patientfirstName, ' ', patientlastName) as patientName, phoneNumber, visitFor, dateCreated, dateOfAppointment, timeOfAppointment, doctorNote FROM appointments WHERE status = 'New' AND doctorId = " . $_SESSION['user_id'];
...
<?php
    $sql = "SELECT CONCAT(patientfirstName, ' ', patientlastName) as patientName, phoneNumber, visitFor, dateCreated, dateOfAppointment, timeOfAppointment, doctorNote FROM appointments WHERE status = 'Approved' AND doctorId = " . $_SESSION['user_id'];
...
<?php
    $sql = "SELECT CONCAT(patientfirstName, ' ', patientlastName) as patientName, phoneNumber, visitFor, dateCreated, dateOfAppointment, timeOfAppointment, doctorNote FROM appointments WHERE dateOfAppointment < CURDATE() AND doctorNote IS NOT NULL AND doctorId = " . $_SESSION['user_id'];
    ...
    <body>
        ...
        <script>
            $(function () {
                ...
                $newCountsQuery = "SELECT DATE(dateOfAppointment) AS AppointmentDate, COUNT(*) AS count FROM appointments WHERE status='new' AND doctorId = " . $_SESSION['user_id'] . " GROUP BY DATE(dateOfAppointment)";
